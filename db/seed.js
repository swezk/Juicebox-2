...
async function createInitialPosts() {
  ...
  try {
    ...
    await createPost({
      ...
      tags: ["#happy", "#youcandoanything", "#canmandoeveryything"]
    });
...
async function testDB() {
  try {
    ...
    const updatePostTagsResult = await updatePost(posts[1].id, {
      ...
      console.log("updatePost on posts[1], only updating tags:", updatePostTagsResult);
    ...
    const userPosts = await getPostsByUser(1);
      console.log("getPostsByUser result: ", userPosts)

      console.log("Calling getPostsByTagName with #happy");
    const postsWithHappy = await getPostsByTagName("#happy");
      console.log("Posts with Happy are: ", postsWithHappy)
